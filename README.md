...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 58f37c42-e675-467a-a0f3-fbb550fd1e8e
```

> `58f37c42-e675-467a-a0f3-fbb550fd1e8e` is the password of the certificate, you can change it to any password you want.
